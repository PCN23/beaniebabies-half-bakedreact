...
export default function BeanieDetail() {
  ...
  useEffect(() => {
    ...
    // you'll need to define a fetch function here (then call it below)
    //that gets this page's beanie baby 
    //and injects it into state using the correct state handler
    fetchBeanie();
  ...
  function handleBeanieClick() {
    // here's a challenge. How can you link on click to the 
    //beanie baby's correct entry in the official beanie baby fan site?
  }
